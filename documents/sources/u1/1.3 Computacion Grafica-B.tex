...
\subsection{Ejemplos de uso de primitivas de dibujo}

\subsubsection{Proyecto Símbolo}

\begin{figure}[!htp] \centering \fboxsep=1mm 
\fbox{\includegraphics[width=0.25\textwidth]{images/t-1-3_app-code-3}}
\caption{Señal de riesgo por radiación ionizante dibujado en el contexto gráfico.}
\end{figure}

\begin{minipage}[c]{0.95\textwidth}
\lstinputlisting[
	caption=Aplicación para dibujar el símbolo de riesgo radiactivo., 
]{source-codes/t-1-3_code-3_Main.java}
\end{minipage}

\textbf{Método translate}\\
Mueve el centro del sistema de coordenadas al punto especificado.
\begin{itemize}
\item void translate(double x, double y)
\end{itemize}

\begin{minipage}[c]{0.95\textwidth}
\lstinputlisting[
	caption=Clase RadioactiveSymbol., 
]{source-codes/t-1-3_code-3_RadioactiveSymbol.java}
\end{minipage}

\newpage
\subsubsection{Proyecto Dibujo}

\begin{figure}[!htp] \centering \fboxsep=1mm 
\fbox{\includegraphics[width=0.6\textwidth]{images/t-1-3_app-code-4}}
\caption{Dibujo de figuras en el contexto gráfico.}
\end{figure}

\begin{minipage}[c]{0.95\textwidth}
\lstinputlisting[
	caption=Aplicación para dibujar figuras en el contexto gráfico., 
]{source-codes/t-1-3_code-4_Main.java}
\end{minipage}

\begin{minipage}[c]{0.95\textwidth}
\lstinputlisting[
	caption=Clase DrawPane (Parte 1)., 
	firstline=1,lastline=64
]{source-codes/t-1-3_code-4_DrawPane.java}
\end{minipage}

\begin{minipage}[c]{0.95\textwidth}
\lstinputlisting[
	caption=Clase DrawPane (Parte 2)., 
	firstline=64
]{source-codes/t-1-3_code-4_DrawPane.java}
\end{minipage}
